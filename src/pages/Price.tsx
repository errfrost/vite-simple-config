...
const priceList = [
    {
        price: 5000,
        lessons: 'абонемент на 12 занятий',
        duration: 'действует 5 недель',
    },
    {
        price: 4500,
        lessons: 'абонемент на 8 занятий',
        duration: 'действует 5 недель',
    },
    {
        price: 3000,
        lessons: 'абонемент на 4 занятия',
        duration: 'действует 5 недель',
    },
    { price: 800, lessons: 'разовое посещение', duration: 'разовое посещение' },
];
        ...
        <>
            ...
            <Container maxWidth="lg" sx={{ py: 4 }}>
                ...
                >
                    ...
                    срока. Абонемент не закрепляется за одной группой или
                    инструктором, вы можете посещать все занятия студии по
                    расписанию. Абонемент необходимо активировать в течение
                    месяца с момента покупки. Через 30 дней после покупки
