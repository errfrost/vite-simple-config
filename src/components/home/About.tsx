        ...
        <Container maxWidth="md">
            ...
            >
                ...
                <Typography variant="body1" component="p" p={2} align="center">
                    ËGA hall — это место, куда вы можете прийти, чтоб
                    позаниматься йогой, расслабиться, пообщаться с интересными
                    людьми и просто насладиться приятной спокойной атмосферой.
                    Студия находится в центре Бишкека, к нам легко добраться из
                    любой точки города.
                </Typography>
